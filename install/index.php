...
Class property_proplink extends CModule {

	var $MODULE_ID = 'property.proplink';
	var $MODULE_VERSION;
	...
	public function __construct() {
		...
		$this->PARTNER_NAME        = GetMessage('property.proplink_PARTNER_NAME');
		$this->PARTNER_URI         = GetMessage('property.proplink_PARTNER_URI');
	}
